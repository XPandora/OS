...
static int getnumwidth(unsigned long long num, unsigned base)
{
	int num_width = 0;
	if (num == 0)
	{
...
static void
printonlynum(void (*putch)(int, void *), void *putdat,
						 unsigned long long num, unsigned base)
{
	if (num >= base)
	{
		printonlynum(putch, putdat, num / base, base);
	}
				 ...
				 unsigned long long num, unsigned base, int width, int padc)
{
	...
	int num_width = getnumwidth(num, base);
	int rest_width = width - num_width;
	...
	printonlynum(putch, putdat, num, base);
